...
let mutable lst = []
let mutable str = ""
// for i in 20 .. 10 .. 20 do
//   for m = 1 to 5 do
//     for mrl = 5 to 10 do
//       for w = 1 to 5 do
//         for wrl = 5 to 10 do
//           for whl = 5 to 10 do
//           let envi = new environment(i, m, mrl, w, wrl, whl, false)
//           lst <- []
//           for k = 0 to 10 do
...
for i = 10 to 15 do 
  for j = 5 to 10 do
    let envi = new environment(100, 10, i, 20, j, 5, false)
    lst <- []
    for k = 0 to 50 do
      let m : int = envi.board.moose.Length
      let w : int = envi.board.wolves.Length
